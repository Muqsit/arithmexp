...
final class FunctionRegistry{
	...
	public static function createDefault() : self{
		$registry = new self();
		$registry->register("abs", Closure::fromCallable("abs"), FunctionFlags::DETERMINISTIC);
		...
		$registry->register("ceil", Closure::fromCallable("ceil"), FunctionFlags::DETERMINISTIC);
		...
		$registry->register("floor", Closure::fromCallable("floor"), FunctionFlags::DETERMINISTIC);
		...
		$registry->register("max", static fn(int|float $num1, int|float ...$nums) : int|float => max([$num1, ...$nums]), FunctionFlags::DETERMINISTIC | FunctionFlags::COMMUTATIVE);
		$registry->register("min", static fn(int|float $num1, int|float ...$nums) : int|float => min([$num1, ...$nums]), FunctionFlags::DETERMINISTIC | FunctionFlags::COMMUTATIVE);
		...
		$registry->register("round", Closure::fromCallable("round"), FunctionFlags::DETERMINISTIC);
